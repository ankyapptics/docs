...
<ParamField body="useCursor" type="boolean" default="false">
...
curl -X POST [https://crm.apptics.ai/api/public/v1/payments](https://crm.apptics.ai/api/public/v1/payments) \
